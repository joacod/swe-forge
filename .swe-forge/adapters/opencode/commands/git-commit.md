...
its `commit` action only. Apply that action to the user-provided arguments below;
keep this adapter as a thin loader and do not perform another delivery action.
