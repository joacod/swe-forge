...
Reuse an existing PR when one is already open; otherwise show or generate the
title and body and create the PR with the host's supported CLI. Never merge,
approve, close, force-push, or switch to the default branch as a side effect.
